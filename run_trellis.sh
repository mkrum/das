...
mkdir -p ~/das_data
while true; do
    #python main.py trellis.yml $(mktemp -p ~/das_data -d) --DFA.alpha_num 2 --model.n_tokens 4 --model.nlayers $NL
    #python main.py trellis.yml $(mktemp -p ~/das_data -d) --DFA.alpha_num 4 --model.n_tokens 6 --model.nlayers $NL
